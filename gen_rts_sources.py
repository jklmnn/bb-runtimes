...
def main():
    ...
    parser.add_argument(
        '--source-profile', choices=['bb_srcs', 'pikeos_srcs'],
        default='bb_srcs', help='platform specific source selections')
    ...
    # on pikeos.
    rts_srcs = SourceTree(
        sources=args.source_profile, profile=args.rts_profile,
